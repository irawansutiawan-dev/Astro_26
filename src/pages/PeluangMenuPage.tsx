...
const subTopics = [
  { label: "Ruang Sampel dan Titik Sampel", path: "" },
  { label: "Peluang Teoretik", path: "" },
  { label: "Peluang Empirik", path: "" },
  { label: "Frekuensi Harapan", path: "" },
];
  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center gradient-space overflow-hidden">
      ...
      <div className="relative z-10 max-w-3xl w-full px-4 py-10">
        ...
        <p className="text-white/60 text-sm text-center mb-8 font-body">Kelas 9 — Pilih sub-topik</p>
